...
namespace DataSync360.DAL
{
    ...
    public class Category_360Dac
    {
        ...
        #region  成员方法
        public int AddNew(Category_360Entity model)
        {
            string sql = "SELECT DISTINCT SysNo FROM dbo.Category_360 WHERE Cateid = "+ Util.ToSqlString(Convert.ToString(model.Cateid));
